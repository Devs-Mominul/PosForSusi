...
<body>
    <div class="container">
        <div class="row d-flex align-items-center justify-between">
            ...
            <div class="col-lg-4  ">
               <div class="custom-btn-parent text-center">
                <button type="button"  class="custom-btn" id="custom_btn">Login</button>
               </div>
                 <ul class="nav navbar-nav text-center nav-list">
                    <li style="margin-top: 5%"><a  href="{{ route('custom.auth.user') }}" class=" btn btn-sm btn-warning" >User Login</a></li>
