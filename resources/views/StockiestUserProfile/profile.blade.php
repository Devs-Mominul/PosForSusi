...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('stockiest.admin.user.profile.post') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
...
<div class=" col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('stockiest.admin.user.password.update') }}" method="post" >
